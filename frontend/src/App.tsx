...
const APP_CONFIG = {
  ...
  learnContent: [
    { id: 1, icon: BrainCircuit, title: { en: "The Science of 'Feeling'", zh: "情绪的科学机制" }, desc: { en: "Emotions are chemical signals in your brain—real, but not always accurate reflections of reality. Understanding this can help you respond rather than react.", zh: "情绪是大脑中的化学信号——真实存在，但并不总是准确反映现实。理解这一点可以帮助你做出回应，而非冲动反应。" } },
    { id: 2, icon: Wind, title: { en: "Why We Need Rest", zh: "为什么我们需要休息" }, desc: { en: "Rest isn't laziness—it's essential system maintenance. Your brain processes emotions and consolidates memories during downtime.", zh: "休息不是懒惰——而是必要的系统维护。大脑在休息时处理情绪、巩固记忆。" } },
    { id: 3, icon: Lightbulb, title: { en: "Grounding 101", zh: "着陆练习入门" }, desc: { en: "When thoughts spiral, try the 5-4-3-2-1 technique: notice 5 things you see, 4 you touch, 3 you hear, 2 you smell, 1 you taste.", zh: "当思绪开始打转时，试试 5-4-3-2-1 技巧：注意5样你看到的、4样你触碰的、3样你听到的、2样你闻到的、1样你尝到的。" } },
    { id: 4, icon: Heart, title: { en: "What Anxiety Feels Like", zh: "焦虑是什么感觉" }, desc: { en: "Racing heart, tight chest, endless \"what ifs\"—anxiety is your brain's alarm system working overtime. It's uncomfortable, but not dangerous.", zh: "心跳加速、胸口发紧、无尽的「万一」——焦虑是大脑警报系统的过度运转。虽然不舒服，但并不危险。" } },
    { id: 5, icon: Sun, title: { en: "Mood Swings Are Normal", zh: "情绪波动是正常的" }, desc: { en: "Especially in your teens and early twenties, hormonal changes make emotions more intense. You're not broken—you're developing.", zh: "特别是在青少年和二十岁出头时，荷尔蒙变化会让情绪更加强烈。你没有坏掉——你在成长。" } },
    { id: 6, icon: Coffee, title: { en: "The Burnout Warning Signs", zh: "倦怠的预警信号" }, desc: { en: "Exhaustion even after rest, cynicism, feeling ineffective—burnout creeps up slowly. Catching it early makes recovery easier.", zh: "休息后仍然疲惫、变得愤世嫉俗、感觉自己没用——倦怠是慢慢累积的。尽早发现，更容易恢复。" } },
    { id: 7, icon: Moon, title: { en: "Sleep & Your Mind", zh: "睡眠与心理健康" }, desc: { en: "Poor sleep doesn't just make you tired—it amplifies negative emotions and impairs decision-making. Prioritizing sleep is self-care.", zh: "睡眠不好不只是让你累——还会放大负面情绪、影响决策能力。重视睡眠就是照顾自己。" } },
    { id: 8, icon: MessageCircle, title: { en: "Social Anxiety Decoded", zh: "社交焦虑解密" }, desc: { en: "That fear of being judged? Your brain is trying to protect you from social rejection. But it often overestimates the threat.", zh: "那种害怕被评判的恐惧？是大脑在试图保护你免受社交排斥。但它常常高估了威胁。" } },
    { id: 9, icon: Sparkles, title: { en: "Self-Care Isn't Selfish", zh: "自我关怀不是自私" }, desc: { en: "You can't pour from an empty cup. Taking care of your needs isn't selfish—it's necessary for being there for others.", zh: "你没法从空杯子里倒出水来。照顾自己的需求不是自私——而是能够支持他人的前提。" } },
    { id: 10, icon: Zap, title: { en: "When You Feel 'Not Enough'", zh: "当你觉得自己不够好" }, desc: { en: "Imposter syndrome affects most people at some point. Those feelings of inadequacy often hit the most capable people hardest.", zh: "冒名顶替综合症几乎影响过每个人。那种不够格的感觉，往往在最有能力的人身上最强烈。" } },
    { id: 11, icon: Stars, title: { en: "Asking for Help Is Brave", zh: "寻求帮助是勇敢的" }, desc: { en: "Reaching out isn't weakness—it's wisdom. Even the strongest people need support sometimes. You don't have to figure it all out alone.", zh: "寻求帮助不是软弱——而是智慧。即使最坚强的人有时也需要支持。你不必独自搞清楚一切。" } },
    { id: 12, icon: Globe, title: { en: "Digital Wellness", zh: "数字健康" }, desc: { en: "Social media can amplify comparison and FOMO. It's okay to take breaks, curate your feed, and remember that highlights aren't real life.", zh: "社交媒体会放大比较心理和错失焦虑。休息一下、筛选你的信息流、记住精彩片段不等于真实生活，这些都是可以的。" } }
  ],
