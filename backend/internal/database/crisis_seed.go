...
func SeedCrisisScripts(db *gorm.DB) int {
	scripts := []CrisisScriptDB{
		...
		// Chinese scripts
		{
			...
			Language:        "zh",
			CrisisLevels:    "[3]",
			TriggerExamples: `["我想死", "不想活了", "想结束生命", "活着没意思", "死了算了", "想去死"]`,
			TriggerKeywords: `["想死", "不想活", "结束生命", "去死"]`,
			DisplayOrder:    1,
			Content:         "【倾听】我听到你说有不想活的念头。能说出来需要很大的勇气。\n【共情】承载这些想法一定非常沉重。你的痛苦是真实的。\n【确认】你能告诉我更多是什么让你有这样的感觉吗？\n【转介】在我陪着你的同时，有专门受过训练的人可以提供更多帮助——他们24小时都在。",
			IsActive:        true,
		},
		{
			Title:           "自伤冲动 - 安全优先",
			...
			Language:        "zh",
			CrisisLevels:    "[3]",
			TriggerExamples: `["我想伤害自己", "想割自己", "想自残", "有自伤的冲动", "我在伤害自己", "想用刀划自己"]`,
			TriggerKeywords: `["自伤", "自残", "割", "伤害自己"]`,
			DisplayOrder:    2,
			Content:         "【倾听】谢谢你愿意诚实地说出这些冲动。我很高兴你愿意谈论它。\n【共情】有这些冲动并不意味着你坏了——这说明你正在承受真实的痛苦。\n【确认】现在，你安全吗？身边有什么让你担心的东西吗？\n【转介】危机热线可以帮助你找到今晚保持安全的方法。",
			IsActive:        true,
		},
		{
			Title:           "结束生命的计划 - 紧急转介",
			...
			Language:        "zh",
			CrisisLevels:    "[3]",
			TriggerExamples: `["我有计划了", "我知道怎么做了", "我准备好了", "我已经想好怎么结束", "今晚就是最后一晚"]`,
			TriggerKeywords: `["计划", "准备好", "最后", "怎么做"]`,
			DisplayOrder:    3,
			Content:         "【倾听】我真的很高兴你告诉我这些。这显示了力量。\n【共情】你现在的痛苦一定感觉难以承受。\n【确认】我想确认我理解了——你有伤害自己的具体计划吗？\n【转介】我真的需要你现在和能帮助你保持安全的人谈谈。我们可以一起拨打危机热线吗？",
			IsActive:        true,
		},
		{
			Title:           "活着太累了",
			...
			Language:        "zh",
			CrisisLevels:    "[3]",
			TriggerExamples: `["活着好累", "活着太累了", "生活太累了", "累得想死", "不想再撑下去了", "活着好辛苦"]`,
			TriggerKeywords: `["活着累", "太累", "撑不下去", "辛苦"]`,
			DisplayOrder:    4,
			Content:         "【倾听】我听到你有多疲惫。活着不应该这么难。\n【共情】对生活感到如此疲倦……每天背负这样的重量太沉重了。\n【确认】事情是什么时候开始变得这么难的？\n【转介】有些人专门帮助处理这种疲惫。你愿意听听关于他们的事吗？",
			IsActive:        true,
		},
		{
			Title:           "没有人会在意",
			...
			Language:        "zh",
			CrisisLevels:    "[3]",
			TriggerExamples: `["没人在乎我", "我死了也没人会在意", "没人会想我", "我消失了没人会注意", "我走了没人会难过"]`,
			TriggerKeywords: `["没人在乎", "没人在意", "没人会想", "消失"]`,
			DisplayOrder:    5,
			Content:         "【倾听】我听到你觉得自己是隐形的，好像没有人会注意到。\n【共情】感觉不被看见是最孤独的痛苦之一。\n【确认】我注意到你了。我在这里。你能告诉我更多是什么让你有这种感觉吗？\n【转介】有些人的工作就是看到和支持正在经历这些的人。他们在乎。",
			IsActive:        true,
		},
		{
			Title:           "想离开这个世界",
			...
			Language:        "zh",
			CrisisLevels:    "[3]",
			TriggerExamples: `["想离开这个世界", "不想在这个世界了", "想从这个世界消失", "不属于这里", "想永远离开"]`,
			TriggerKeywords: `["离开世界", "消失", "不属于", "永远离开"]`,
			DisplayOrder:    6,
			Content:         "【倾听】我听到你想让痛苦停止。这是我听到的。\n【共情】痛苦一定非常强烈，以至于离开感觉是唯一的选择。\n【确认】需要什么改变才能让留下来成为可能？\n【转介】专业的咨询师可以帮助探索其他度过这种痛苦的方法。你会考虑和一位谈谈吗？",
			IsActive:        true,
		},
		// English Level 3 scripts
		{
			...
			Language:        "en",
			CrisisLevels:    "[3]",
			TriggerExamples: `["I want to die", "I don't want to live anymore", "I want to end my life", "I wish I was dead", "I want to kill myself"]`,
			TriggerKeywords: `["want to die", "end my life", "kill myself", "don't want to live"]`,
			DisplayOrder:    7,
		...
		},
		{
			...
			Language:        "en",
			CrisisLevels:    "[3]",
			TriggerExamples: `["I want to hurt myself", "I want to cut myself", "I have urges to self-harm", "I've been hurting myself", "I want to feel pain"]`,
			TriggerKeywords: `["hurt myself", "cut myself", "self-harm", "hurting myself"]`,
			DisplayOrder:    8,
		...
		},
		{
			...
			Language:        "en",
			CrisisLevels:    "[3]",
			TriggerExamples: `["I'm a burden", "Everyone would be better off without me", "I'm just a burden to everyone", "My family would be happier without me"]`,
			TriggerKeywords: `["burden", "better off without me", "happier without me"]`,
			DisplayOrder:    9,
		...
		},
		{
			...
			Language:        "en",
			CrisisLevels:    "[3]",
			TriggerExamples: `["I just want the pain to stop", "I can't take this pain anymore", "Make it stop", "The pain is unbearable", "I need this to end"]`,
			TriggerKeywords: `["pain to stop", "can't take", "unbearable", "need this to end"]`,
			DisplayOrder:    10,
		...
		},
		{
			...
			Language:        "en",
			CrisisLevels:    "[3]",
			TriggerExamples: `["Nobody would care if I'm gone", "No one would miss me", "Nobody cares about me", "No one would notice if I disappeared"]`,
			TriggerKeywords: `["nobody would care", "no one would miss", "nobody cares", "wouldn't notice"]`,
			DisplayOrder:    11,
		...
		},
		{
			...
			Language:        "en",
			CrisisLevels:    "[3]",
			TriggerExamples: `["I've tried everything", "Nothing works", "I've tried so hard", "Nothing helps anymore", "I give up trying"]`,
			TriggerKeywords: `["tried everything", "nothing works", "nothing helps", "give up"]`,
			DisplayOrder:    12,
		...
		// Chinese Level 2 scripts
		{
			...
			Language:        "zh",
			CrisisLevels:    "[2]",
			TriggerExamples: `["感觉好绝望", "看不到希望", "没有希望了", "一切都没有意义", "前面是一片黑暗"]`,
			TriggerKeywords: `["绝望", "没有希望", "看不到希望"]`,
			DisplayOrder:    20,
			Content:         "【倾听】我听到现在一切都感觉没有希望。\n【共情】当我们看不到前进的路时，一切都感觉更沉重。\n【确认】对你来说，有希望是什么样子的？",
			IsActive:        true,
		},
		{
			Title:           "没人理解我",
			...
			Language:        "zh",
			CrisisLevels:    "[2]",
			TriggerExamples: `["没人理解我", "没人懂我", "我说什么都没人听", "他们不理解我在经历什么", "我感觉被误解"]`,
			TriggerKeywords: `["没人理解", "没人懂", "不理解我", "被误解"]`,
			DisplayOrder:    21,
			Content:         "【倾听】感觉不被理解是如此孤立。我听到了。\n【共情】解释自己却仍然感觉不被看见是很累人的。\n【确认】你能告诉我你希望人们理解你什么吗？",
			IsActive:        true,
		},
		{
			Title:           "活着没意思",
			...
			Language:        "zh",
			CrisisLevels:    "[2]",
			TriggerExamples: `["活着没意思", "生活好无聊", "每天都一样没意思", "不知道活着为了什么", "找不到活着的意义"]`,
			TriggerKeywords: `["没意思", "无聊", "没意义", "为了什么"]`,
			DisplayOrder:    22,
			Content:         "【倾听】我听到生活现在感觉空虚和没有意义。\n【共情】当一切都感觉平淡时，很难找到参与的理由。\n【确认】有没有一段时间事情感觉有意义？那时有什么不同？",
			IsActive:        true,
		},
		{
			Title:           "撑不下去了",
			...
			Language:        "zh",
			CrisisLevels:    "[2]",
			TriggerExamples: `["撑不下去了", "我快崩溃了", "我受不了了", "我快要到极限了", "我真的撑不住了"]`,
			TriggerKeywords: `["撑不下去", "崩溃", "受不了", "极限", "撑不住"]`,
			DisplayOrder:    23,
			Content:         "【倾听】我听到你已经到了极限。\n【共情】你一直在坚持那么多。这需要真正的力量。\n【确认】最难承受的部分是什么？",
			IsActive:        true,
		},
		{
			Title:           "我很孤独",
			...
			Language:        "zh",
			CrisisLevels:    "[2]",
			TriggerExamples: `["我好孤独", "我很寂寞", "没有人陪我", "我感觉好孤单", "我一个人"]`,
			TriggerKeywords: `["孤独", "寂寞", "孤单", "一个人"]`,
			DisplayOrder:    24,
			Content:         "【倾听】孤独是最难承受的感觉之一。\n【共情】你可以被人包围但仍然感觉完全孤独。\n【确认】什么样的连接现在会让你感觉好一点？",
			IsActive:        true,
		},
		{
			Title:           "我放弃了",
			...
			Language:        "zh",
			CrisisLevels:    "[2]",
			TriggerExamples: `["我放弃了", "我不想再努力了", "算了不管了", "随便吧", "我不想再试了"]`,
			TriggerKeywords: `["放弃", "不想努力", "算了", "不想试"]`,
			DisplayOrder:    25,
			Content:         "【倾听】我听到你已经到了一个放弃感觉是唯一选择的地步。\n【共情】你已经战斗了这么久。累了是可以的。\n【确认】你希望什么会不一样？",
			IsActive:        true,
		},
		// English Level 2 scripts
		{
			...
			Language:        "en",
			CrisisLevels:    "[2]",
			TriggerExamples: `["I feel hopeless", "There's no hope", "I can't see any way out", "Everything is pointless", "Nothing will ever change"]`,
			TriggerKeywords: `["hopeless", "no hope", "pointless", "no way out"]`,
			DisplayOrder:    26,
		...
		},
		{
			...
			Language:        "en",
			CrisisLevels:    "[2]",
			TriggerExamples: `["Nobody understands me", "No one gets it", "They don't understand what I'm going through", "I feel so misunderstood", "No one listens"]`,
			TriggerKeywords: `["nobody understands", "no one gets it", "misunderstood", "no one listens"]`,
			DisplayOrder:    27,
		...
		},
		{
			...
			Language:        "en",
			CrisisLevels:    "[2]",
			TriggerExamples: `["Life feels meaningless", "What's the point", "Nothing matters anymore", "I don't see the purpose", "Everything feels empty"]`,
			TriggerKeywords: `["meaningless", "what's the point", "nothing matters", "empty"]`,
			DisplayOrder:    28,
		...
		},
		{
			...
			Language:        "en",
			CrisisLevels:    "[2]",
			TriggerExamples: `["I can't keep going", "I'm at my limit", "I can't do this anymore", "I'm breaking down", "I can't take it"]`,
			TriggerKeywords: `["can't keep going", "at my limit", "can't do this", "breaking down"]`,
			DisplayOrder: 29,
		...
		},
		{
			...
			Language:        "en",
			CrisisLevels:    "[2]",
			TriggerExamples: `["I'm so alone", "I feel so lonely", "I have no one", "I'm all alone", "No one is there for me"]`,
			TriggerKeywords: `["alone", "lonely", "no one", "isolated"]`,
			DisplayOrder:    30,
		...
		// Chinese Level 1 scripts
		{
			...
			Language:        "zh",
			CrisisLevels:    "[1]",
			TriggerExamples: `["压力好大", "压力太大了", "我压力很大", "感觉压力山大", "快被压垮了"]`,
			TriggerKeywords: `["压力", "压垮"]`,
			DisplayOrder:    40,
			Content:         "【倾听】我听到你现在压力很大。\n【共情】感到不堪重负是令人疲惫的，无论是精神上还是身体上。\n【确认】什么最让你感到沉重？",
			IsActive:        true,
		},
		{
			Title:           "心情不好",
			...
			Language:        "zh",
			CrisisLevels:    "[1]",
			TriggerExamples: `["心情不好", "心情很差", "今天心情不太好", "我不开心", "心情低落"]`,
			TriggerKeywords: `["心情不好", "不开心", "心情差", "低落"]`,
			DisplayOrder:    41,
			Content:         "【倾听】我能感觉到你今天心情不太好。\n【共情】有时候我们的心情就是会低落，这是正常的。\n【确认】发生了什么？还是只是那种日子之一？",
			IsActive:        true,
		},
		{
			Title:           "焦虑不安",
			...
			Language:        "zh",
			CrisisLevels:    "[1]",
			TriggerExamples: `["我很焦虑", "好焦虑啊", "焦虑不安", "心里很慌", "紧张得不行"]`,
			TriggerKeywords: `["焦虑", "紧张", "慌", "不安"]`,
			DisplayOrder:    42,
			Content:         "【倾听】我听到你感到焦虑。胸口那种不舒服的嗡嗡声。\n【共情】焦虑可以让一切都感觉比需要的更困难。\n【确认】你的焦虑现在集中在什么上？",
			IsActive:        true,
		},
		{
			Title:           "学习/工作太累了",
			...
			Language:        "zh",
			CrisisLevels:    "[1]",
			TriggerExamples: `["学习好累", "工作太累了", "上班好累", "学业压力好大", "考试压力大"]`,
			TriggerKeywords: `["学习累", "工作累", "上班累", "考试压力"]`,
			DisplayOrder:    43,
			Content:         "【倾听】我听到学习/工作真的让你很累。\n【共情】持续的要求真的会消耗我们的能量。\n【确认】最近有什么特别难的事情吗？",
			IsActive:        true,
		},
		{
			Title:           "烦躁易怒",
			...
			Language:        "zh",
			CrisisLevels:    "[1]",
			TriggerExamples: `["好烦啊", "烦死了", "我很烦躁", "什么都让我烦", "容易发脾气"]`,
			TriggerKeywords: `["烦", "烦躁", "发脾气", "易怒"]`,
			DisplayOrder:    44,
			Content:         "【倾听】我能感觉到你很沮丧和紧张。\n【共情】当我们耐心不足时，一切都感觉更烦人。\n【确认】什么一直让你不舒服？",
			IsActive:        true,
		},
		// English Level 1 scripts
		{
			...
			Language:        "en",
			CrisisLevels:    "[1]",
			TriggerExamples: `["I'm so stressed", "I'm stressed out", "Too much stress", "I feel overwhelmed", "Everything is stressing me out"]`,
			TriggerKeywords: `["stressed", "stress", "overwhelmed"]`,
			DisplayOrder:    45,
		...
		},
		{
			...
			Language:        "en",
			CrisisLevels:    "[1]",
			TriggerExamples: `["I'm in a bad mood", "My mood is terrible", "I feel down", "Not feeling great", "I'm feeling low"]`,
			TriggerKeywords: `["bad mood", "feel down", "feeling low", "not great"]`,
			DisplayOrder:    46,
		...
		},
		{
			...
			Language:        "en",
			CrisisLevels:    "[1]",
			TriggerExamples: `["I'm feeling anxious", "I have anxiety", "I'm so anxious", "I can't stop worrying", "My anxiety is bad"]`,
			TriggerKeywords: `["anxious", "anxiety", "worrying", "worried"]`,
			DisplayOrder:    47,
		...
		},
		{
			...
			Language:        "en",
			CrisisLevels:    "[1]",
			TriggerExamples: `["Work is killing me", "School is too much", "I'm exhausted from work", "Too much homework", "I can't handle the workload"]`,
			TriggerKeywords: `["work", "school", "exhausted", "too much", "workload"]`,
			DisplayOrder:    48,
		...
		// ============ Special Scenarios ============
		{
			...
			Language:        "en",
			CrisisLevels:    "[]",
			TriggerExamples: `["I don't want to call", "I don't need help", "No thanks", "I'm fine", "I don't want to talk to anyone else"]`,
			TriggerKeywords: `["don't want", "no thanks", "I'm fine", "don't need"]`,
			DisplayOrder:    60,
		...
		},
		{
			...
			Language:        "zh",
			CrisisLevels:    "[]",
			TriggerExamples: `["我不想打电话", "不需要帮助", "不用了", "我没事", "我不想和别人说"]`,
			TriggerKeywords: `["不想打", "不需要", "不用了", "没事"]`,
			DisplayOrder:    61,
			Content:         "【倾听】我听到你现在不想打热线电话。\n【共情】这完全是你的选择，我尊重它。\n【确认】我不会离开。现在什么会让你感觉有帮助？",
			IsActive:        true,
		},
		{
			...
			Language:        "en",
			CrisisLevels:    "[]",
			TriggerExamples: `["Thank you", "Thanks for listening", "I appreciate it", "That helps", "Thanks for being here"]`,
			TriggerKeywords: `["thank", "thanks", "appreciate"]`,
			DisplayOrder:    62,
		...
		},
		{
			...
			Language:        "zh",
			CrisisLevels:    "[]",
			TriggerExamples: `["谢谢你", "谢谢", "感谢你听我说", "谢谢陪我聊天", "你帮了我"]`,
			TriggerKeywords: `["谢谢", "感谢", "谢"]`,
			DisplayOrder:    63,
			Content:         "谢谢你和我分享这些。花时间处理你的感受很重要。我一直都在。",
			IsActive:        true,
		},
		{
			...
			Language:        "en",
			CrisisLevels:    "[]",
			TriggerExamples: `["I feel better", "That helped", "I'm feeling a bit better now", "Things are looking up", "I think I'll be okay"]`,
			TriggerKeywords: `["feel better", "helped", "better now", "okay"]`,
			DisplayOrder:    64,
		...
		},
		{
			...
			Language:        "zh",
			CrisisLevels:    "[]",
			TriggerExamples: `["我好点了", "感觉好多了", "心情好一些了", "没那么难受了", "我觉得可以了"]`,
			TriggerKeywords: `["好点了", "好多了", "好一些", "可以了"]`,
			DisplayOrder:    65,
			Content:         "这是积极的一步。有倒退也是可以的——康复不是线性的。我为你照顾好自己感到骄傲。",
			IsActive:        true,
		},
		{
			...
			Language:        "en",
			CrisisLevels:    "[]",
			TriggerExamples: `["I'm so angry", "This is so frustrating", "I hate this", "I'm pissed off", "Nothing ever goes right"]`,
			TriggerKeywords: `["angry", "frustrated", "hate", "pissed"]`,
			DisplayOrder:    66,
		...
		},
		{
			...
			Language:        "zh",
			CrisisLevels:    "[]",
			TriggerExamples: `["我好生气", "气死我了", "太气人了", "我恨死了", "为什么总是这样"]`,
			TriggerKeywords: `["生气", "气死", "气人", "恨"]`,
			DisplayOrder:    67,
			Content:         "【倾听】我听到你现在真的很沮丧。\n【共情】生气是可以的。你的感受是有效的。\n【确认】你能告诉我发生了什么吗？",
			IsActive:        true,
		},
	}
